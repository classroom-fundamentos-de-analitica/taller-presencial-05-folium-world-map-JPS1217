...
assert dataframe.loc["United States of America"] == 579
assert dataframe.loc["China"] == 273
assert dataframe.loc["India"] == 174
assert dataframe.loc["United Kingdom"] == 173
assert dataframe.loc["Italy"] == 112
